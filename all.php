					...
					<div class="sec_inner">
						<div class="feature_cont">
							...
							<div class="feature_cont_txt">
								...
								<p>カメラ、ドレス、腕時計、家電など様々な商品を、<br class="spNone">個人間なので<span
										class="is-bold">安い価格でレンタル</span>出来ます。<br class="spNone"><span
										class="is-bold">お支払いはクレジット決済</span>でらくらく。<br
										class="spNone">個人間での取引のため消費税もかかりません。</p>
							</div>
							<!-- /feature_cont_txt -->
						</div>
						<!-- /feature_cont -->
					...
					<div class="sec_inner">
						<div class="feature_cont">
							<div class="feature_cont_img">
								...
								<img src="images/image2.png" width="290" height="390" alt="使いたいモノをレンタルしよう♪"
									class="img-screen" loading="lazy">
							</div>
							<!-- /feature_cont_img -->
							<div class="feature_cont_txt">
								<h3>使っていない物を<br>貸してみよう!</h3>
								<p>まるでメルカリの様に<span class="is-bold">3分でかんたん出品。</span><br class="spNone">副業にもおススメ。<br
										class="spNone">個人間レンタルで<br class="spNone">お金を稼ごう♪</p>
							</div>
							<!-- /feature_cont_txt -->
						</div>
						<!-- /feature_cont -->
					...
					<div class="sec_inner">
						<div class="feature_cont">
							<div class="feature_cont_img">
								...
								<img src="images/ketuana.png" width="265" height="400" alt="安心への取り組みも充実"
									class="img-screen" loading="lazy">
							</div>
							<!-- /feature_cont_img -->
							<div class="feature_cont_txt">
								<h3>安心への取り組みも<br>充実</h3>
								<p>電話番号と身分証で本人確認があり、<br class="spNone">レンタルにはWAKKA独自の審査を設けています。<br
										class="spNone">貸し出す商品代を確保する<br class="spNone">デポジット機能があります。</p>
							</div>
							<!-- /feature_cont_txt -->
						</div>
						<!-- /feature_cont -->
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/7lPRbuVnYj0" style="display: block; margin: auto; title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
