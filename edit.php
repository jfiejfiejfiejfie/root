        ...
        <form method="POST" action="edit_db.php" enctype="multipart/form-data">
          ...
          try{
            ...
            <ul>
                <li>
                    <label>年齢:
                        <input type="number" name="age" placeholder="年齢" value="<?php echo htmlspecialchars($row["age"]); ?>" required>
                    </label>
                </li>
                <li>性別:
                ...
                <li>
                    <label>E-mail:
                        <input type="text" name="email" placeholder="E-mail" value="<?php echo htmlspecialchars($row["email"]); ?>" required>
                    </label>
                </li>
                <li>
                    <label>コメント:
